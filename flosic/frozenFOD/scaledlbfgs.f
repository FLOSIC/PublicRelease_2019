...
!        subroutine electronic_geometry(energy)
         ...
         logical optimized,EXIST,E1,E2,E3
         integer frozen
         character*40 NAME
         dimension msite(2),mfreeze(2)
         dimension r(3,1000),f(3,1000)
         dimension frozen(1000)
...
C        If file 'Table' did not exist, scaling factors will be 1.D0 
 ...
 9       open(90,file='FRMORB')
         ...
         inquire(file='frozen.tmp',EXIST=E3)
         frozen(:)=1 !initial values - not freezing FOD position
         if(E3) then
           open(93,file='frozen.tmp')
           rewind(93)
         !  read(93,*) mfreeze(1), mfreeze(2)
         end if
c
