...
! SHARED WINDOW
  INTEGER :: SIC_WIN
! SHARE MEMORY MASTERS COMMUNICATION
  INTEGER :: NCALLED_MASTERS
  INTEGER :: SHM_MASTER_RANK,MASTER_SIZE,SHM_MASTER_COMM
  INTEGER,ALLOCATABLE :: INUSE_MASTER(:)
! SHARED ACOUL ARRAY WINDOW
  INTEGER :: ACOUL_WIN
! SHARED ACOUL_DFT ARRAY WINDOW AMONGST MASTERS
...
module global_inputs
  ...
  logical :: iimesh,dosjnt1,wfgrid1,dosoccu1,formfak1,atomsph1,matdipole1,nonscf1,nonscfforces1,&
             dftd31,fragment1,polarizability1,rhogrid1,molden1,nbo1,symmetry1,mpi_io1,spnorb1,&
             fixm1,wffrm1,dmat1,libxc1,spnpol1,population1,scaledlbfgs1,scanmesh1
  logical :: cdosjnt,cwfgrid,cdosoccu,cformfak,catomsph,cmatdipole,cnonscf,cnonscfforces,&
             cdftd3,ccalctype,cfragment,cbasis,cpolarizability,crhogrid,cmaxscf,cscftol,cmolden,&
             cnbo,csymmetry,cmpi_io,cspnorb,cfixm,cdmat,cmixing,clibxc
